"""
this file is used to create the vectors for the data of recommendation
in the end we will get the pickle file with all data neccessery
before this file you need to scrape data from the ikea-scrape.py
"""
import cv2
